      ...
      if (e.target.classList.contains("cgkit-swatch")) {
        ...
        switch (label) {
          ...
          case "Middle Inner Color":
            updateColor("middle_middle", colors[value]);
            break;
          case "Ring Middle Color":
            updateColor("ring-middle_connection", colors[value]);
            break;
          case "Ring Inner Color":
            updateColor("ring_middle", colors[value]);
            break;
          ...
          updateColor("pinky_inner", colors[value]);
          break;
          case "Pinky Middle Color":
          updateColor("pinky_middle", colors[value]);
          break;
          ...
          case "Binding Color":
            ...
            break;
          case "Welt Color":
            updateColor("welt", colors[value]);
            break;
          case "Lace Color":
            updateColor("laces", colors[value]);            
            break;
          case "Stitching Color":            
            updateColor('stitches', colors[value]);
          ...
          case "Finger Protector Color":
            ...
            case "Finger Protector":
              if(value === 'finger_pad'){
                ( !materialIsVisible("finger_pad") ) ? child.visible = true : null;
                updateColor("finger_pad", colors[value]);
              } else if (value === 'none'){
                child.visible = false;
              } else {
